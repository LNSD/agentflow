...
**MANDATORY for ALL workspace-level organization in this project**
...
The workspace follows a hierarchical organization under the `crates/` directory with distinct categories. Each category serves a specific architectural purpose.
...
Client libraries for connecting to project services.
