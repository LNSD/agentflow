...
**🚨 MANDATORY for ALL Rust code in this project**
...
- **Distributed system failure** - In distributed systems, a panic in one component can cascade into system-wide failures
